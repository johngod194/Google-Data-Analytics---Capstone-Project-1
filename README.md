...
**In this project, I will be using SQL for cleaning, transformation and analysis. Then the analysis report and visuals will be done on Kaggle using the R language.**
